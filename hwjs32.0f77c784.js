...
function getImages() {
    return fetch(`${URL}?key=${API_KEY}&q=${querry}&image_type=${type}&page=${page}&per_page=${per_page}`).then((res)=>res.json());
}
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire1e0c", {})

//# sourceMappingURL=hwjs32.0f77c784.js.map
